...
public class OnlineMapsHereRoutingAPIResult
{
    ...
    /// </summary>
    public OnlineMapsJSONItem json;
    ...
    public class Section
    {
        ...
        private List<LatLngZ> _polylinePoints;
        private List<OnlineMapsVector2d> _polylinePoints2d;

        public List<LatLngZ> polylinePoints
        {
            get
            {
        ...
        public List<OnlineMapsVector2d> polylinePoints2d
        {
            get
            {
                if (_polylinePoints2d == null)
                {
                    List<LatLngZ> points = polylinePoints;
                    if (points != null) _polylinePoints2d = points.Select(p => new OnlineMapsVector2d(p.Lng, p.Lat)).ToList();
                }

                return _polylinePoints2d;
            }
        }
    }
    ...
    public class LatLngZ
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            LatLngZ latLngZ = obj as LatLngZ;
            if (latLngZ != null)
            {
    ...
    public class PolylineEncoderDecoder
    {
        ...
        private class Encoder
        {
            ...
            public void Add(LatLngZ tuple)
            {
                if (tuple == null)
                {
                    throw new ArgumentNullException("tuple", "Invalid LatLngZ tuple");
                }
